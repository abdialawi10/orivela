          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-gray-600 mb-4">
                {brandFullName} is committed to protecting your privacy. This
            ...
            <section>
              ...
              <p className="text-gray-600 mb-4">
                Our platform integrates with third-party services (Twilio,
                SendGrid, CRM systems, etc.). These services have their own
